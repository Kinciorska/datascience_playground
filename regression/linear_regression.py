...
def calculate_linear_regression(x_train, y_train, x_test, y_test):
...
def calculate_linear_regression_manually(x_train, y_train, x_test, y_test):
    n = 700
    alpha = 0.0001
...
if __name__ == "__main__":
    calculate_linear_regression(x_train, y_train, x_test, y_test)
    calculate_linear_regression_manually(x_train, y_train, x_test, y_test)
